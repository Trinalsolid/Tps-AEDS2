...
class Film {
    ...
    public void ler(String fileName){
        ...
        String path = "D:\\RPG\\Filmes\\" + fileName;
...
class Lista {
     ...
     */
    public String pesquisaSequencial(String nome) {
       String resp = "NAO";
       for (int i = 0; i<n;i++){
    ...
    public void sort1() {
        for (int i = 0; i < (n-1); i++) {
           int menor = i;
           for (int j = (i + 1); j < n; j++){
              if(array[menor].getOgTitle().compareTo(array[j].getOgTitle()) > 0){
                //array[menor].getOgTitle().compareTo(array[j].getOgTitle())<0
                menor = j;
              }
           }
           swap(menor, i);
...
//array[i].getOgTitle().compareTo(array[j].getOgTitle()) > 1