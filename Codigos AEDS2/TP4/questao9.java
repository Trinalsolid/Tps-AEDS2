...
class ArvoreBinaria{
	...
	/**
	 * Metodo que retorna o maior elemento da 
	 * @return int maior elemento da 
	 */
   public int getMaior(){
      int resp = -1;
	...
	/**
	 * Metodo que retorna o menor elemento da 
	 * @return int menor elemento da 
	 */
   public int getMenor(){
      int resp = -1;
	...
	/**
	 * Metodo que retorna a altura da 
	 * @return int altura da 
	 */
...
public class questao9{
	...
	public static void comando(String a , char b , ArvoreBinaria d)throws Exception{
		boolean teste = false;
        switch(a){
			case "I":
				d.inserir(b);
			...
			case "P":
				teste = d.pesquisar(b);
                if(teste == false){
                    System.out.println(b + " nao existe");
                }else{
                    System.out.println(b + " existe");
                }
				break;
    ...
    public static void comando2(String a, ArvoreBinaria d)throws Exception{
		switch(a){
			case "INFIXA":
				d.caminharCentral();
				break;
    ...
    public static void main(String[] args) throws Exception {
		...
		while(entrada.hasNextLine()){
            ...
            if(leitura.compareTo("INFIXA") != 0 
            && leitura.compareTo("PREFIXA") != 0 
            &&leitura.compareTo("POSFIXA") != 0 ){
                split = leitura.split(" ",2);
			    parte1 = split[0];
			    //System.out.println(parte1);
			    parte2 = split[1];
                //System.out.println(parte2);
			    letra = parte2.charAt(0);
			    comando(parte1, letra, arvoreB);
            }else{
                comando2(leitura, arvoreB);
            }
