...
class Film {
    ...
    public void splittingString(String path){
        // Data declaration
        String line = "";
     ...
     * @return
     */
    public int hoursToMinutes(String value){
        // Data declaration
     ...
     * @return
     */
    public Float convertBudget(String value){
    ...
    public String toString() {
        ...
        sb.append(" ").append(ogLanguage);public
...
class Lista {
     ...
     */
    public void inserirInicio(Film x) throws Exception {
     ...
     * @throws Exception Se a lista estiver cheia.
     */
    public void inserirFim(Film x) throws Exception {
     ...
     * 
     */
     public String pesquisaSeq(String nome){
        String resp = "NAO";
        for(int i=0; i<n; i++){
...
public class GabaritoDaniel3 {
    ...
    numEntrada--;
    //Q1 Film[] array = new Film(numEntrada);
    ...
    while(isFim(nome)==false){
        System.out.println(lista.pesquisaSeq(nome));
